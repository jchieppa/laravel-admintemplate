...
<head>
    ...
    <!-- Generated: 2019-04-04 16:13:15 +0200 -->
            ...
            <div class="container">
                <div class="d-flex">
                    <a class="header-brand" href="{{ route('admin.home') }}">
                        <img src="{{ asset('assets/images/logo.jpg') }}" class="header-brand-img" alt="Village Charter School logo">
                        <span class="brand-text font-weight-light">{{ config('app.vcs.name') }}</span>
                    </a>
